            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Detail Data Penjualan</h1>
                        <ol class="breadcrumb mb-4">
                            Selamat datang di aplikasi kasir! Lakukan transaksi penjualan disini!
                        </ol>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#insert">
 Tambah
</button>
        ...
        <tbody>
            <?php
                include "koneksi.php";
                $query    =mysqli_query($koneksi, "SELECT * FROM detail_penjualan ORDER BY detailID DESC");
                $no=0;
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Input Data Transaksi Penjualan</h4>
      ...
      <form action="index.php" method="post" name="form1">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="penjualanID" placeholder="Masukkan ID Penjualan">
            </div>
            <div class="form-group">
