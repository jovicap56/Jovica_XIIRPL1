                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            Ini adalah data produk toko! Lakukan penambahan produk disini!
                        </ol>
 ...
 Tambah
        ...
        <tbody>
            ...
            <tr>            
                ...
                <td><a href="edit.php?produkID=<?=$data['produkID']?>">Edit</a> | <a href="hapus.php?produkID=<?=$data['produkID']?>">Hapus</a></td>
            </tr>
            <?php
                }
            ?>
